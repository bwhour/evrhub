...
contract EvrnetBridge {
    using SafeMath for uint256;

    string EVRNET_NATIVE_ASSET_PREFIX = "PEGGY";
    ...
    struct ProphecyClaim {
        ...
        address payable evrnetReceiver;
    ...
    event LogNewProphecyClaim(
        ...
        address payable _evrnetReceiver,
    ...
    function newProphecyClaim(
        ...
        if (_claimType == ClaimType.Burn) {
            ...
            symbol = concat(EVRNET_NATIVE_ASSET_PREFIX, _symbol); // Add 'PEGGY' symbol prefix
