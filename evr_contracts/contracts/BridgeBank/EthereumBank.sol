...
contract EthereumBank {
     ...
     *
     * @param _ethereumSender: The sender's evrnet address.
    ...
    function newEthereumDeposit(
        ...
        bytes32 depositID = keccak256(
            abi.encodePacked(_ethereumSender, _evrnetRecipient, _token, _amount)
        );
     ...
     * @param _evrnetRecipient: The intended recipient's Ethereum address.
