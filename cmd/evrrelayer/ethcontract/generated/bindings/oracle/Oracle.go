...
// DeployOracle deploys a new Ethereum ethContract, binding an instance of Oracle to it.
func DeployOracle(auth *bind.TransactOpts, backend bind.ContractBackend, _operator common.Address, _valset common.Address, _cosmosBridge common.Address, _consensusThreshold *big.Int) (common.Address, *types.Transaction, *Oracle, error) {
	...
	address, tx, ethContract, err := bind.DeployContract(auth, parsed, common.FromHex(OracleBin), backend, _operator, _valset, _cosmosBridge, _consensusThreshold)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &Oracle{OracleCaller: OracleCaller{ethContract: ethContract}, OracleTransactor: OracleTransactor{ethContract: ethContract}, OracleFilterer: OracleFilterer{ethContract: ethContract}}, nil
}

// Oracle is an auto generated Go binding around an Ethereum ethContract.
type Oracle struct {
	OracleCaller     // Read-only binding to the ethContract
	OracleTransactor // Write-only binding to the ethContract
	OracleFilterer   // Log filterer for ethContract events
}

// OracleCaller is an auto generated read-only Go binding around an Ethereum ethContract.
type OracleCaller struct {
	ethContract *bind.BoundContract // Generic ethContract wrapper for the low level calls
}

// OracleTransactor is an auto generated write-only Go binding around an Ethereum ethContract.
type OracleTransactor struct {
	ethContract *bind.BoundContract // Generic ethContract wrapper for the low level calls
}

// OracleFilterer is an auto generated log filtering Go binding around an Ethereum ethContract events.
type OracleFilterer struct {
	ethContract *bind.BoundContract // Generic ethContract wrapper for the low level calls
}

// OracleSession is an auto generated Go binding around an Ethereum ethContract,
// with pre-set call and transact options.
type OracleSession struct {
	Contract     *Oracle           // Generic ethContract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// OracleCallerSession is an auto generated read-only Go binding around an Ethereum ethContract,
// with pre-set call options.
type OracleCallerSession struct {
	Contract *OracleCaller // Generic ethContract caller binding to set the session for
	CallOpts bind.CallOpts // Call options to use throughout this session
}

// OracleTransactorSession is an auto generated write-only Go binding around an Ethereum ethContract,
// with pre-set transact options.
type OracleTransactorSession struct {
	Contract     *OracleTransactor // Generic ethContract transactor binding to set the session for
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// OracleRaw is an auto generated low-level Go binding around an Ethereum ethContract.
type OracleRaw struct {
	Contract *Oracle // Generic ethContract binding to access the raw methods on
}

// OracleCallerRaw is an auto generated low-level read-only Go binding around an Ethereum ethContract.
type OracleCallerRaw struct {
	Contract *OracleCaller // Generic read-only ethContract binding to access the raw methods on
}

// OracleTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum ethContract.
type OracleTransactorRaw struct {
	Contract *OracleTransactor // Generic write-only ethContract binding to access the raw methods on
}

// NewOracle creates a new instance of Oracle, bound to a specific deployed ethContract.
func NewOracle(address common.Address, backend bind.ContractBackend) (*Oracle, error) {
	ethContract, err := bindOracle(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &Oracle{OracleCaller: OracleCaller{ethContract: ethContract}, OracleTransactor: OracleTransactor{ethContract: ethContract}, OracleFilterer: OracleFilterer{ethContract: ethContract}}, nil
}

// NewOracleCaller creates a new read-only instance of Oracle, bound to a specific deployed ethContract.
func NewOracleCaller(address common.Address, caller bind.ContractCaller) (*OracleCaller, error) {
	ethContract, err := bindOracle(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &OracleCaller{ethContract: ethContract}, nil
}

// NewOracleTransactor creates a new write-only instance of Oracle, bound to a specific deployed ethContract.
func NewOracleTransactor(address common.Address, transactor bind.ContractTransactor) (*OracleTransactor, error) {
	ethContract, err := bindOracle(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &OracleTransactor{ethContract: ethContract}, nil
}

// NewOracleFilterer creates a new log filterer instance of Oracle, bound to a specific deployed ethContract.
func NewOracleFilterer(address common.Address, filterer bind.ContractFilterer) (*OracleFilterer, error) {
	ethContract, err := bindOracle(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &OracleFilterer{ethContract: ethContract}, nil
}

// bindOracle binds a generic wrapper to an already deployed ethContract.
...
func (_Oracle *OracleRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _Oracle.Contract.OracleCaller.ethContract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the ethContract, calling
// its default method if one is available.
func (_Oracle *OracleRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Oracle.Contract.OracleTransactor.ethContract.Transfer(opts)
}

// Transact invokes the (paid) ethContract method with params as input values.
func (_Oracle *OracleRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Oracle.Contract.OracleTransactor.ethContract.Transact(opts, method, params...)
}
...
func (_Oracle *OracleCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _Oracle.Contract.ethContract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the ethContract, calling
// its default method if one is available.
func (_Oracle *OracleTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Oracle.Contract.ethContract.Transfer(opts)
}

// Transact invokes the (paid) ethContract method with params as input values.
func (_Oracle *OracleTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Oracle.Contract.ethContract.Transact(opts, method, params...)
}

// CheckBridgeProphecy is a free data retrieval call binding the ethContract method 0xe33a8b2a.
//
...
func (_Oracle *OracleCaller) CheckBridgeProphecy(opts *bind.CallOpts, _prophecyID *big.Int) (bool, *big.Int, *big.Int, error) {
	...
	err := _Oracle.ethContract.Call(opts, out, "checkBridgeProphecy", _prophecyID)
...
// ConsensusThreshold is a free data retrieval call binding the ethContract method 0xf9b0b5b9.
//
...
func (_Oracle *OracleCaller) ConsensusThreshold(opts *bind.CallOpts) (*big.Int, error) {
	...
	out := ret0
	err := _Oracle.ethContract.Call(opts, out, "consensusThreshold")
	return *ret0, err
}
...
// EvrnetBridge is a free data retrieval call binding the ethContract method 0xb0e9ef71.
//
...
func (_Oracle *OracleCaller) EvrnetBridge(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _Oracle.ethContract.Call(opts, out, "cosmosBridge")
	return *ret0, err
}
...
// HasMadeClaim is a free data retrieval call binding the ethContract method 0xa219763e.
//
...
func (_Oracle *OracleCaller) HasMadeClaim(opts *bind.CallOpts, arg0 *big.Int, arg1 common.Address) (bool, error) {
	...
	out := ret0
	err := _Oracle.ethContract.Call(opts, out, "hasMadeClaim", arg0, arg1)
	return *ret0, err
}
...
func (_Oracle *OracleCaller) Operator(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _Oracle.ethContract.Call(opts, out, "operator")
	return *ret0, err
}
...
// OracleClaimValidators is a free data retrieval call binding the ethContract method 0x36e41341.
//
...
func (_Oracle *OracleCaller) OracleClaimValidators(opts *bind.CallOpts, arg0 *big.Int, arg1 *big.Int) (common.Address, error) {
	...
	out := ret0
	err := _Oracle.ethContract.Call(opts, out, "oracleClaimValidators", arg0, arg1)
	return *ret0, err
}
...
func (_Oracle *OracleCaller) Valset(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _Oracle.ethContract.Call(opts, out, "valset")
	return *ret0, err
}
...
// NewOracleClaim is a paid mutator transaction binding the ethContract method 0x568b3c4f.
//
...
func (_Oracle *OracleTransactor) NewOracleClaim(opts *bind.TransactOpts, _prophecyID *big.Int, _message [32]byte, _signature []byte) (*types.Transaction, error) {
	return _Oracle.ethContract.Transact(opts, "newOracleClaim", _prophecyID, _message, _signature)
}
...
// ProcessBridgeProphecy is a paid mutator transaction binding the ethContract method 0x89ed70b7.
//
...
func (_Oracle *OracleTransactor) ProcessBridgeProphecy(opts *bind.TransactOpts, _prophecyID *big.Int) (*types.Transaction, error) {
	return _Oracle.ethContract.Transact(opts, "processBridgeProphecy", _prophecyID)
}
...
// OracleLogNewOracleClaimIterator is returned from FilterLogNewOracleClaim and is used to iterate over the raw logs and unpacked data for LogNewOracleClaim events raised by the Oracle ethContract.
type OracleLogNewOracleClaimIterator struct {
	Event *OracleLogNewOracleClaim // Event containing the ethContract specifics and raw log
...
// OracleLogNewOracleClaim represents a LogNewOracleClaim event raised by the Oracle ethContract.
...
// FilterLogNewOracleClaim is a free log retrieval operation binding the ethContract event 0x50e466de4726c2437aa7498d554322f5599f31f0f69f9ce036ad96db77590491.
//
...
func (_Oracle *OracleFilterer) FilterLogNewOracleClaim(opts *bind.FilterOpts) (*OracleLogNewOracleClaimIterator, error) {
	...
	logs, sub, err := _Oracle.ethContract.FilterLogs(opts, "LogNewOracleClaim")
	if err != nil {
		return nil, err
	}
	return &OracleLogNewOracleClaimIterator{ethContract: _Oracle.ethContract, event: "LogNewOracleClaim", logs: logs, sub: sub}, nil
}

// WatchLogNewOracleClaim is a free log subscription operation binding the ethContract event 0x50e466de4726c2437aa7498d554322f5599f31f0f69f9ce036ad96db77590491.
//
// Solidity: event LogNewOracleClaim(uint256 _prophecyID, bytes32 _message, address _validatorAddress, bytes _signature)
func (_Oracle *OracleFilterer) WatchLogNewOracleClaim(opts *bind.WatchOpts, sink chan<- *OracleLogNewOracleClaim) (event.Subscription, error) {
	...
	logs, sub, err := _Oracle.ethContract.WatchLogs(opts, "LogNewOracleClaim")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Oracle.ethContract.UnpackLog(event, "LogNewOracleClaim", log); err != nil {
					return err
				}
				event.Raw = log
...
// OracleLogProphecyProcessedIterator is returned from FilterLogProphecyProcessed and is used to iterate over the raw logs and unpacked data for LogProphecyProcessed events raised by the Oracle ethContract.
type OracleLogProphecyProcessedIterator struct {
	Event *OracleLogProphecyProcessed // Event containing the ethContract specifics and raw log
...
// OracleLogProphecyProcessed represents a LogProphecyProcessed event raised by the Oracle ethContract.
...
// FilterLogProphecyProcessed is a free log retrieval operation binding the ethContract event 0x1d8e3fbd601d9d92db7022fb97f75e132841b94db732dcecb0c93cb31852fcbc.
//
...
func (_Oracle *OracleFilterer) FilterLogProphecyProcessed(opts *bind.FilterOpts) (*OracleLogProphecyProcessedIterator, error) {
	...
	logs, sub, err := _Oracle.ethContract.FilterLogs(opts, "LogProphecyProcessed")
	if err != nil {
		return nil, err
	}
	return &OracleLogProphecyProcessedIterator{ethContract: _Oracle.ethContract, event: "LogProphecyProcessed", logs: logs, sub: sub}, nil
}

// WatchLogProphecyProcessed is a free log subscription operation binding the ethContract event 0x1d8e3fbd601d9d92db7022fb97f75e132841b94db732dcecb0c93cb31852fcbc.
//
// Solidity: event LogProphecyProcessed(uint256 _prophecyID, uint256 _prophecyPowerCurrent, uint256 _prophecyPowerThreshold, address _submitter)
func (_Oracle *OracleFilterer) WatchLogProphecyProcessed(opts *bind.WatchOpts, sink chan<- *OracleLogProphecyProcessed) (event.Subscription, error) {
	...
	logs, sub, err := _Oracle.ethContract.WatchLogs(opts, "LogProphecyProcessed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Oracle.ethContract.UnpackLog(event, "LogProphecyProcessed", log); err != nil {
					return err
				}
				event.Raw = log
