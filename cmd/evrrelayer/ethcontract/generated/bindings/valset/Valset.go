...
// DeployValset deploys a new Ethereum ethContract, binding an instance of Valset to it.
func DeployValset(auth *bind.TransactOpts, backend bind.ContractBackend, _operator common.Address, _initValidators []common.Address, _initPowers []*big.Int) (common.Address, *types.Transaction, *Valset, error) {
	...
	address, tx, ethContract, err := bind.DeployContract(auth, parsed, common.FromHex(ValsetBin), backend, _operator, _initValidators, _initPowers)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &Valset{ValsetCaller: ValsetCaller{ethContract: ethContract}, ValsetTransactor: ValsetTransactor{ethContract: ethContract}, ValsetFilterer: ValsetFilterer{ethContract: ethContract}}, nil
}

// Valset is an auto generated Go binding around an Ethereum ethContract.
type Valset struct {
	ValsetCaller     // Read-only binding to the ethContract
	ValsetTransactor // Write-only binding to the ethContract
	ValsetFilterer   // Log filterer for ethContract events
}

// ValsetCaller is an auto generated read-only Go binding around an Ethereum ethContract.
type ValsetCaller struct {
	ethContract *bind.BoundContract // Generic ethContract wrapper for the low level calls
}

// ValsetTransactor is an auto generated write-only Go binding around an Ethereum ethContract.
type ValsetTransactor struct {
	ethContract *bind.BoundContract // Generic ethContract wrapper for the low level calls
}

// ValsetFilterer is an auto generated log filtering Go binding around an Ethereum ethContract events.
type ValsetFilterer struct {
	ethContract *bind.BoundContract // Generic ethContract wrapper for the low level calls
}

// ValsetSession is an auto generated Go binding around an Ethereum ethContract,
// with pre-set call and transact options.
type ValsetSession struct {
	Contract     *Valset           // Generic ethContract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// ValsetCallerSession is an auto generated read-only Go binding around an Ethereum ethContract,
// with pre-set call options.
type ValsetCallerSession struct {
	Contract *ValsetCaller // Generic ethContract caller binding to set the session for
	CallOpts bind.CallOpts // Call options to use throughout this session
}

// ValsetTransactorSession is an auto generated write-only Go binding around an Ethereum ethContract,
// with pre-set transact options.
type ValsetTransactorSession struct {
	Contract     *ValsetTransactor // Generic ethContract transactor binding to set the session for
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// ValsetRaw is an auto generated low-level Go binding around an Ethereum ethContract.
type ValsetRaw struct {
	Contract *Valset // Generic ethContract binding to access the raw methods on
}

// ValsetCallerRaw is an auto generated low-level read-only Go binding around an Ethereum ethContract.
type ValsetCallerRaw struct {
	Contract *ValsetCaller // Generic read-only ethContract binding to access the raw methods on
}

// ValsetTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum ethContract.
type ValsetTransactorRaw struct {
	Contract *ValsetTransactor // Generic write-only ethContract binding to access the raw methods on
}

// NewValset creates a new instance of Valset, bound to a specific deployed ethContract.
func NewValset(address common.Address, backend bind.ContractBackend) (*Valset, error) {
	ethContract, err := bindValset(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &Valset{ValsetCaller: ValsetCaller{ethContract: ethContract}, ValsetTransactor: ValsetTransactor{ethContract: ethContract}, ValsetFilterer: ValsetFilterer{ethContract: ethContract}}, nil
}

// NewValsetCaller creates a new read-only instance of Valset, bound to a specific deployed ethContract.
func NewValsetCaller(address common.Address, caller bind.ContractCaller) (*ValsetCaller, error) {
	ethContract, err := bindValset(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &ValsetCaller{ethContract: ethContract}, nil
}

// NewValsetTransactor creates a new write-only instance of Valset, bound to a specific deployed ethContract.
func NewValsetTransactor(address common.Address, transactor bind.ContractTransactor) (*ValsetTransactor, error) {
	ethContract, err := bindValset(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &ValsetTransactor{ethContract: ethContract}, nil
}

// NewValsetFilterer creates a new log filterer instance of Valset, bound to a specific deployed ethContract.
func NewValsetFilterer(address common.Address, filterer bind.ContractFilterer) (*ValsetFilterer, error) {
	ethContract, err := bindValset(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ValsetFilterer{ethContract: ethContract}, nil
}

// bindValset binds a generic wrapper to an already deployed ethContract.
...
// Call invokes the (constant) ethContract method with params as input values and
...
func (_Valset *ValsetRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _Valset.Contract.ValsetCaller.ethContract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the ethContract, calling
// its default method if one is available.
func (_Valset *ValsetRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Valset.Contract.ValsetTransactor.ethContract.Transfer(opts)
}

// Transact invokes the (paid) ethContract method with params as input values.
func (_Valset *ValsetRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Valset.Contract.ValsetTransactor.ethContract.Transact(opts, method, params...)
}
...
func (_Valset *ValsetCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _Valset.Contract.ethContract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the ethContract, calling
// its default method if one is available.
func (_Valset *ValsetTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Valset.Contract.ethContract.Transfer(opts)
}

// Transact invokes the (paid) ethContract method with params as input values.
func (_Valset *ValsetTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Valset.Contract.ethContract.Transact(opts, method, params...)
}

// CurrentValsetVersion is a free data retrieval call binding the ethContract method 0x8d56c37d.
//
...
func (_Valset *ValsetCaller) CurrentValsetVersion(opts *bind.CallOpts) (*big.Int, error) {
	...
	out := ret0
	err := _Valset.ethContract.Call(opts, out, "currentValsetVersion")
	return *ret0, err
}
...
// GetValidatorPower is a free data retrieval call binding the ethContract method 0x473691a4.
//
...
func (_Valset *ValsetCaller) GetValidatorPower(opts *bind.CallOpts, _validatorAddress common.Address) (*big.Int, error) {
	...
	out := ret0
	err := _Valset.ethContract.Call(opts, out, "getValidatorPower", _validatorAddress)
	return *ret0, err
}
...
// IsActiveValidator is a free data retrieval call binding the ethContract method 0x40550a1c.
//
...
func (_Valset *ValsetCaller) IsActiveValidator(opts *bind.CallOpts, _validatorAddress common.Address) (bool, error) {
	...
	out := ret0
	err := _Valset.ethContract.Call(opts, out, "isActiveValidator", _validatorAddress)
	return *ret0, err
}
...
// Operator is a free data retrieval call binding the ethContract method 0x570ca735.
//
...
func (_Valset *ValsetCaller) Operator(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _Valset.ethContract.Call(opts, out, "operator")
	return *ret0, err
}
...
// Powers is a free data retrieval call binding the ethContract method 0xb872c523.
//
...
func (_Valset *ValsetCaller) Powers(opts *bind.CallOpts, arg0 [32]byte) (*big.Int, error) {
	...
	out := ret0
	err := _Valset.ethContract.Call(opts, out, "powers", arg0)
	return *ret0, err
}
...
// Recover is a free data retrieval call binding the ethContract method 0x19045a25.
//
...
func (_Valset *ValsetCaller) Recover(opts *bind.CallOpts, _message [32]byte, _signature []byte) (common.Address, error) {
	...
	out := ret0
	err := _Valset.ethContract.Call(opts, out, "recover", _message, _signature)
	return *ret0, err
}
...
// TotalPower is a free data retrieval call binding the ethContract method 0xdb3ad22c.
//
...
func (_Valset *ValsetCaller) TotalPower(opts *bind.CallOpts) (*big.Int, error) {
	...
	out := ret0
	err := _Valset.ethContract.Call(opts, out, "totalPower")
	return *ret0, err
}
...
// ValidatorCount is a free data retrieval call binding the ethContract method 0x0f43a677.
//
...
func (_Valset *ValsetCaller) ValidatorCount(opts *bind.CallOpts) (*big.Int, error) {
	...
	out := ret0
	err := _Valset.ethContract.Call(opts, out, "validatorCount")
	return *ret0, err
}
...
// Validators is a free data retrieval call binding the ethContract method 0x9bdafcb3.
//
...
func (_Valset *ValsetCaller) Validators(opts *bind.CallOpts, arg0 [32]byte) (bool, error) {
	...
	out := ret0
	err := _Valset.ethContract.Call(opts, out, "validators", arg0)
	return *ret0, err
}
...
// AddValidator is a paid mutator transaction binding the ethContract method 0xfc6c1f02.
//
...
func (_Valset *ValsetTransactor) AddValidator(opts *bind.TransactOpts, _validatorAddress common.Address, _validatorPower *big.Int) (*types.Transaction, error) {
	return _Valset.ethContract.Transact(opts, "addValidator", _validatorAddress, _validatorPower)
}
...
// RecoverGas is a paid mutator transaction binding the ethContract method 0xb5672be3.
//
...
func (_Valset *ValsetTransactor) RecoverGas(opts *bind.TransactOpts, _valsetVersion *big.Int, _validatorAddress common.Address) (*types.Transaction, error) {
	return _Valset.ethContract.Transact(opts, "recoverGas", _valsetVersion, _validatorAddress)
}
...
// RemoveValidator is a paid mutator transaction binding the ethContract method 0x40a141ff.
//
...
func (_Valset *ValsetTransactor) RemoveValidator(opts *bind.TransactOpts, _validatorAddress common.Address) (*types.Transaction, error) {
	return _Valset.ethContract.Transact(opts, "removeValidator", _validatorAddress)
}
...
// UpdateValidatorPower is a paid mutator transaction binding the ethContract method 0x2e75293b.
//
...
func (_Valset *ValsetTransactor) UpdateValidatorPower(opts *bind.TransactOpts, _validatorAddress common.Address, _newValidatorPower *big.Int) (*types.Transaction, error) {
	return _Valset.ethContract.Transact(opts, "updateValidatorPower", _validatorAddress, _newValidatorPower)
}
...
// UpdateValset is a paid mutator transaction binding the ethContract method 0x788cf92f.
//
...
func (_Valset *ValsetTransactor) UpdateValset(opts *bind.TransactOpts, _validators []common.Address, _powers []*big.Int) (*types.Transaction, error) {
	return _Valset.ethContract.Transact(opts, "updateValset", _validators, _powers)
}
...
// ValsetLogValidatorAddedIterator is returned from FilterLogValidatorAdded and is used to iterate over the raw logs and unpacked data for LogValidatorAdded events raised by the Valset ethContract.
type ValsetLogValidatorAddedIterator struct {
	Event *ValsetLogValidatorAdded // Event containing the ethContract specifics and raw log

	ethContract *bind.BoundContract // Generic ethContract to use for unpacking event data
	event    string              // Event name to use for unpacking event data

	logs chan types.Log        // Log channel receiving the found ethContract events
...
func (it *ValsetLogValidatorAddedIterator) Next() bool {
	...
	if it.done {
		...
		case log := <-it.logs:
			...
			if err := it.ethContract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
			it.Event.Raw = log
...
// ValsetLogValidatorAdded represents a LogValidatorAdded event raised by the Valset ethContract.
...
// FilterLogValidatorAdded is a free log retrieval operation binding the ethContract event 0x1a396bcf647502e902dce665d58a0c1b25f982f193ab9a1d0f1500d8d927bf2a.
//
...
func (_Valset *ValsetFilterer) FilterLogValidatorAdded(opts *bind.FilterOpts) (*ValsetLogValidatorAddedIterator, error) {
	...
	logs, sub, err := _Valset.ethContract.FilterLogs(opts, "LogValidatorAdded")
	if err != nil {
		return nil, err
	}
	return &ValsetLogValidatorAddedIterator{ethContract: _Valset.ethContract, event: "LogValidatorAdded", logs: logs, sub: sub}, nil
}

// WatchLogValidatorAdded is a free log subscription operation binding the ethContract event 0x1a396bcf647502e902dce665d58a0c1b25f982f193ab9a1d0f1500d8d927bf2a.
//
// Solidity: event LogValidatorAdded(address _validator, uint256 _power, uint256 _currentValsetVersion, uint256 _validatorCount, uint256 _totalPower)
func (_Valset *ValsetFilterer) WatchLogValidatorAdded(opts *bind.WatchOpts, sink chan<- *ValsetLogValidatorAdded) (event.Subscription, error) {
	...
	logs, sub, err := _Valset.ethContract.WatchLogs(opts, "LogValidatorAdded")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Valset.ethContract.UnpackLog(event, "LogValidatorAdded", log); err != nil {
					return err
				}
				event.Raw = log
...
// ValsetLogValidatorPowerUpdatedIterator is returned from FilterLogValidatorPowerUpdated and is used to iterate over the raw logs and unpacked data for LogValidatorPowerUpdated events raised by the Valset ethContract.
type ValsetLogValidatorPowerUpdatedIterator struct {
	Event *ValsetLogValidatorPowerUpdated // Event containing the ethContract specifics and raw log
...
// ValsetLogValidatorPowerUpdated represents a LogValidatorPowerUpdated event raised by the Valset ethContract.
...
// FilterLogValidatorPowerUpdated is a free log retrieval operation binding the ethContract event 0x335940ce4119f8aae891d73dba74510a3d51f6210134d058237f26e6a31d5340.
//
...
func (_Valset *ValsetFilterer) FilterLogValidatorPowerUpdated(opts *bind.FilterOpts) (*ValsetLogValidatorPowerUpdatedIterator, error) {
	...
	logs, sub, err := _Valset.ethContract.FilterLogs(opts, "LogValidatorPowerUpdated")
	if err != nil {
		return nil, err
	}
	return &ValsetLogValidatorPowerUpdatedIterator{ethContract: _Valset.ethContract, event: "LogValidatorPowerUpdated", logs: logs, sub: sub}, nil
}

// WatchLogValidatorPowerUpdated is a free log subscription operation binding the ethContract event 0x335940ce4119f8aae891d73dba74510a3d51f6210134d058237f26e6a31d5340.
//
// Solidity: event LogValidatorPowerUpdated(address _validator, uint256 _power, uint256 _currentValsetVersion, uint256 _validatorCount, uint256 _totalPower)
func (_Valset *ValsetFilterer) WatchLogValidatorPowerUpdated(opts *bind.WatchOpts, sink chan<- *ValsetLogValidatorPowerUpdated) (event.Subscription, error) {
	...
	logs, sub, err := _Valset.ethContract.WatchLogs(opts, "LogValidatorPowerUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Valset.ethContract.UnpackLog(event, "LogValidatorPowerUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
// ValsetLogValidatorRemovedIterator is returned from FilterLogValidatorRemoved and is used to iterate over the raw logs and unpacked data for LogValidatorRemoved events raised by the Valset ethContract.
type ValsetLogValidatorRemovedIterator struct {
	Event *ValsetLogValidatorRemoved // Event containing the ethContract specifics and raw log
...
// ValsetLogValidatorRemoved represents a LogValidatorRemoved event raised by the Valset ethContract.
...
// FilterLogValidatorRemoved is a free log retrieval operation binding the ethContract event 0x1241fb43a101ff98ab819a1882097d4ccada51ba60f326c1981cc48840f55b8c.
//
...
func (_Valset *ValsetFilterer) FilterLogValidatorRemoved(opts *bind.FilterOpts) (*ValsetLogValidatorRemovedIterator, error) {
	...
	logs, sub, err := _Valset.ethContract.FilterLogs(opts, "LogValidatorRemoved")
	if err != nil {
		return nil, err
	}
	return &ValsetLogValidatorRemovedIterator{ethContract: _Valset.ethContract, event: "LogValidatorRemoved", logs: logs, sub: sub}, nil
}

// WatchLogValidatorRemoved is a free log subscription operation binding the ethContract event 0x1241fb43a101ff98ab819a1882097d4ccada51ba60f326c1981cc48840f55b8c.
//
// Solidity: event LogValidatorRemoved(address _validator, uint256 _power, uint256 _currentValsetVersion, uint256 _validatorCount, uint256 _totalPower)
func (_Valset *ValsetFilterer) WatchLogValidatorRemoved(opts *bind.WatchOpts, sink chan<- *ValsetLogValidatorRemoved) (event.Subscription, error) {
	...
	logs, sub, err := _Valset.ethContract.WatchLogs(opts, "LogValidatorRemoved")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Valset.ethContract.UnpackLog(event, "LogValidatorRemoved", log); err != nil {
					return err
				}
				event.Raw = log
...
// ValsetLogValsetResetIterator is returned from FilterLogValsetReset and is used to iterate over the raw logs and unpacked data for LogValsetReset events raised by the Valset ethContract.
type ValsetLogValsetResetIterator struct {
	Event *ValsetLogValsetReset // Event containing the ethContract specifics and raw log
...
// ValsetLogValsetReset represents a LogValsetReset event raised by the Valset ethContract.
...
// FilterLogValsetReset is a free log retrieval operation binding the ethContract event 0xd870653e19f161500290fd0c4ca41bf5cf2bcb1ba66448f41c66c512dabd65f2.
//
...
func (_Valset *ValsetFilterer) FilterLogValsetReset(opts *bind.FilterOpts) (*ValsetLogValsetResetIterator, error) {
	...
	logs, sub, err := _Valset.ethContract.FilterLogs(opts, "LogValsetReset")
	if err != nil {
		return nil, err
	}
	return &ValsetLogValsetResetIterator{ethContract: _Valset.ethContract, event: "LogValsetReset", logs: logs, sub: sub}, nil
}

// WatchLogValsetReset is a free log subscription operation binding the ethContract event 0xd870653e19f161500290fd0c4ca41bf5cf2bcb1ba66448f41c66c512dabd65f2.
//
// Solidity: event LogValsetReset(uint256 _newValsetVersion, uint256 _validatorCount, uint256 _totalPower)
func (_Valset *ValsetFilterer) WatchLogValsetReset(opts *bind.WatchOpts, sink chan<- *ValsetLogValsetReset) (event.Subscription, error) {
	...
	logs, sub, err := _Valset.ethContract.WatchLogs(opts, "LogValsetReset")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Valset.ethContract.UnpackLog(event, "LogValsetReset", log); err != nil {
					return err
				}
				event.Raw = log
...
// ValsetLogValsetUpdatedIterator is returned from FilterLogValsetUpdated and is used to iterate over the raw logs and unpacked data for LogValsetUpdated events raised by the Valset ethContract.
type ValsetLogValsetUpdatedIterator struct {
	Event *ValsetLogValsetUpdated // Event containing the ethContract specifics and raw log
...
// ValsetLogValsetUpdated represents a LogValsetUpdated event raised by the Valset ethContract.
...
// FilterLogValsetUpdated is a free log retrieval operation binding the ethContract event 0x3a7ef0da3179668af8114719645585b5a37092ef2d66f187dcf63d83a221eaa6.
//
...
func (_Valset *ValsetFilterer) FilterLogValsetUpdated(opts *bind.FilterOpts) (*ValsetLogValsetUpdatedIterator, error) {
	...
	logs, sub, err := _Valset.ethContract.FilterLogs(opts, "LogValsetUpdated")
	if err != nil {
		return nil, err
	}
	return &ValsetLogValsetUpdatedIterator{ethContract: _Valset.ethContract, event: "LogValsetUpdated", logs: logs, sub: sub}, nil
}

// WatchLogValsetUpdated is a free log subscription operation binding the ethContract event 0x3a7ef0da3179668af8114719645585b5a37092ef2d66f187dcf63d83a221eaa6.
//
// Solidity: event LogValsetUpdated(uint256 _newValsetVersion, uint256 _validatorCount, uint256 _totalPower)
func (_Valset *ValsetFilterer) WatchLogValsetUpdated(opts *bind.WatchOpts, sink chan<- *ValsetLogValsetUpdated) (event.Subscription, error) {
	...
	logs, sub, err := _Valset.ethContract.WatchLogs(opts, "LogValsetUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Valset.ethContract.UnpackLog(event, "LogValsetUpdated", log); err != nil {
					return err
				}
				event.Raw = log
