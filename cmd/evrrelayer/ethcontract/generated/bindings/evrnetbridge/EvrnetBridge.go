...
// DeployCosmosBridge deploys a new Ethereum ethContract, binding an instance of EvrnetBridge to it.
func DeployCosmosBridge(auth *bind.TransactOpts, backend bind.ContractBackend, _operator common.Address, _valset common.Address) (common.Address, *types.Transaction, *EvrnetBridge, error) {
	parsed, err := abi.JSON(strings.NewReader(EvrnetBridgeABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, ethContract, err := bind.DeployContract(auth, parsed, common.FromHex(CosmosBridgeBin), backend, _operator, _valset)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &EvrnetBridge{CosmosBridgeCaller: CosmosBridgeCaller{ethContract: ethContract}, CosmosBridgeTransactor: CosmosBridgeTransactor{ethContract: ethContract}, CosmosBridgeFilterer: CosmosBridgeFilterer{ethContract: ethContract}}, nil
}

// EvrnetBridge is an auto generated Go binding around an Ethereum ethContract.
type EvrnetBridge struct {
	CosmosBridgeCaller     // Read-only binding to the ethContract
	CosmosBridgeTransactor // Write-only binding to the ethContract
	CosmosBridgeFilterer   // Log filterer for ethContract events
}

// CosmosBridgeCaller is an auto generated read-only Go binding around an Ethereum ethContract.
type CosmosBridgeCaller struct {
	ethContract *bind.BoundContract // Generic ethContract wrapper for the low level calls
}

// CosmosBridgeTransactor is an auto generated write-only Go binding around an Ethereum ethContract.
type CosmosBridgeTransactor struct {
	ethContract *bind.BoundContract // Generic ethContract wrapper for the low level calls
}

// CosmosBridgeFilterer is an auto generated log filtering Go binding around an Ethereum ethContract events.
type CosmosBridgeFilterer struct {
	ethContract *bind.BoundContract // Generic ethContract wrapper for the low level calls
}

// CosmosBridgeSession is an auto generated Go binding around an Ethereum ethContract,
// with pre-set call and transact options.
type CosmosBridgeSession struct {
	Contract     *EvrnetBridge     // Generic ethContract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// CosmosBridgeCallerSession is an auto generated read-only Go binding around an Ethereum ethContract,
// with pre-set call options.
type CosmosBridgeCallerSession struct {
	Contract *CosmosBridgeCaller // Generic ethContract caller binding to set the session for
	CallOpts bind.CallOpts       // Call options to use throughout this session
}

// CosmosBridgeTransactorSession is an auto generated write-only Go binding around an Ethereum ethContract,
// with pre-set transact options.
type CosmosBridgeTransactorSession struct {
	Contract     *CosmosBridgeTransactor // Generic ethContract transactor binding to set the session for
	TransactOpts bind.TransactOpts       // Transaction auth options to use throughout this session
}

// CosmosBridgeRaw is an auto generated low-level Go binding around an Ethereum ethContract.
type CosmosBridgeRaw struct {
	Contract *EvrnetBridge // Generic ethContract binding to access the raw methods on
}

// CosmosBridgeCallerRaw is an auto generated low-level read-only Go binding around an Ethereum ethContract.
type CosmosBridgeCallerRaw struct {
	Contract *CosmosBridgeCaller // Generic read-only ethContract binding to access the raw methods on
}

// CosmosBridgeTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum ethContract.
type CosmosBridgeTransactorRaw struct {
	Contract *CosmosBridgeTransactor // Generic write-only ethContract binding to access the raw methods on
}

// NewCosmosBridge creates a new instance of EvrnetBridge, bound to a specific deployed ethContract.
func NewCosmosBridge(address common.Address, backend bind.ContractBackend) (*EvrnetBridge, error) {
	ethContract, err := bindCosmosBridge(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &EvrnetBridge{CosmosBridgeCaller: CosmosBridgeCaller{ethContract: ethContract}, CosmosBridgeTransactor: CosmosBridgeTransactor{ethContract: ethContract}, CosmosBridgeFilterer: CosmosBridgeFilterer{ethContract: ethContract}}, nil
}

// NewCosmosBridgeCaller creates a new read-only instance of EvrnetBridge, bound to a specific deployed ethContract.
func NewCosmosBridgeCaller(address common.Address, caller bind.ContractCaller) (*CosmosBridgeCaller, error) {
	ethContract, err := bindCosmosBridge(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &CosmosBridgeCaller{ethContract: ethContract}, nil
}

// NewCosmosBridgeTransactor creates a new write-only instance of EvrnetBridge, bound to a specific deployed ethContract.
func NewCosmosBridgeTransactor(address common.Address, transactor bind.ContractTransactor) (*CosmosBridgeTransactor, error) {
	ethContract, err := bindCosmosBridge(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &CosmosBridgeTransactor{ethContract: ethContract}, nil
}

// NewCosmosBridgeFilterer creates a new log filterer instance of EvrnetBridge, bound to a specific deployed ethContract.
func NewCosmosBridgeFilterer(address common.Address, filterer bind.ContractFilterer) (*CosmosBridgeFilterer, error) {
	ethContract, err := bindCosmosBridge(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &CosmosBridgeFilterer{ethContract: ethContract}, nil
}

// bindCosmosBridge binds a generic wrapper to an already deployed ethContract.
...
func (_CosmosBridge *CosmosBridgeRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _CosmosBridge.Contract.CosmosBridgeCaller.ethContract.Call(opts, result, method, params...)
}
...
func (_CosmosBridge *CosmosBridgeRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CosmosBridge.Contract.CosmosBridgeTransactor.ethContract.Transfer(opts)
}
...
func (_CosmosBridge *CosmosBridgeRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _CosmosBridge.Contract.CosmosBridgeTransactor.ethContract.Transact(opts, method, params...)
}
...
func (_CosmosBridge *CosmosBridgeCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _CosmosBridge.Contract.ethContract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the ethContract, calling
// its default method if one is available.
func (_CosmosBridge *CosmosBridgeTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CosmosBridge.Contract.ethContract.Transfer(opts)
}
...
func (_CosmosBridge *CosmosBridgeTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _CosmosBridge.Contract.ethContract.Transact(opts, method, params...)
}

// BridgeBank is a free data retrieval call binding the ethContract method 0x0e41f373.
//
...
func (_CosmosBridge *CosmosBridgeCaller) BridgeBank(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _CosmosBridge.ethContract.Call(opts, out, "bridgeBank")
	return *ret0, err
}
...
// HasBridgeBank is a free data retrieval call binding the ethContract method 0x69294a4e.
//
...
func (_CosmosBridge *CosmosBridgeCaller) HasBridgeBank(opts *bind.CallOpts) (bool, error) {
	...
	out := ret0
	err := _CosmosBridge.ethContract.Call(opts, out, "hasBridgeBank")
	return *ret0, err
}
...
// HasOracle is a free data retrieval call binding the ethContract method 0xfb7831f2.
//
...
func (_CosmosBridge *CosmosBridgeCaller) HasOracle(opts *bind.CallOpts) (bool, error) {
	...
	out := ret0
	err := _CosmosBridge.ethContract.Call(opts, out, "hasOracle")
	return *ret0, err
}
...
// IsProphecyClaimActive is a free data retrieval call binding the ethContract method 0xd8da69ea.
//
...
func (_CosmosBridge *CosmosBridgeCaller) IsProphecyClaimActive(opts *bind.CallOpts, _prophecyID *big.Int) (bool, error) {
	...
	out := ret0
	err := _CosmosBridge.ethContract.Call(opts, out, "isProphecyClaimActive", _prophecyID)
	return *ret0, err
}
...
// IsProphecyClaimValidatorActive is a free data retrieval call binding the ethContract method 0x529f3dd2.
//
...
func (_CosmosBridge *CosmosBridgeCaller) IsProphecyClaimValidatorActive(opts *bind.CallOpts, _prophecyID *big.Int) (bool, error) {
	...
	out := ret0
	err := _CosmosBridge.ethContract.Call(opts, out, "isProphecyClaimValidatorActive", _prophecyID)
	return *ret0, err
}
...
func (_CosmosBridge *CosmosBridgeCaller) Operator(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _CosmosBridge.ethContract.Call(opts, out, "operator")
	return *ret0, err
}
...
// Oracle is a free data retrieval call binding the ethContract method 0x7dc0d1d0.
//
...
func (_CosmosBridge *CosmosBridgeCaller) Oracle(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _CosmosBridge.ethContract.Call(opts, out, "oracle")
	return *ret0, err
}
...
// ProphecyClaimCount is a free data retrieval call binding the ethContract method 0x8ea5352d.
//
...
func (_CosmosBridge *CosmosBridgeCaller) ProphecyClaimCount(opts *bind.CallOpts) (*big.Int, error) {
	...
	out := ret0
	err := _CosmosBridge.ethContract.Call(opts, out, "prophecyClaimCount")
	return *ret0, err
}
...
// ProphecyClaims is a free data retrieval call binding the ethContract method 0xdb4237af.
//
...
func (_CosmosBridge *CosmosBridgeCaller) ProphecyClaims(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	out := ret
	err := _CosmosBridge.ethContract.Call(opts, out, "prophecyClaims", arg0)
	return *ret, err
}
...
// Valset is a free data retrieval call binding the ethContract method 0x7f54af0c.
//
...
func (_CosmosBridge *CosmosBridgeCaller) Valset(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _CosmosBridge.ethContract.Call(opts, out, "valset")
	return *ret0, err
}
...
// CompleteProphecyClaim is a paid mutator transaction binding the ethContract method 0x6b3ce98c.
//
...
func (_CosmosBridge *CosmosBridgeTransactor) CompleteProphecyClaim(opts *bind.TransactOpts, _prophecyID *big.Int) (*types.Transaction, error) {
	return _CosmosBridge.ethContract.Transact(opts, "completeProphecyClaim", _prophecyID)
}
...
// NewProphecyClaim is a paid mutator transaction binding the ethContract method 0x9d396d03.
//
...
func (_CosmosBridge *CosmosBridgeTransactor) NewProphecyClaim(opts *bind.TransactOpts, _claimType uint8, _cosmosSender []byte, _ethereumReceiver common.Address, _symbol string, _amount *big.Int) (*types.Transaction, error) {
	return _CosmosBridge.ethContract.Transact(opts, "newProphecyClaim", _claimType, _cosmosSender, _ethereumReceiver, _symbol, _amount)
}
...
// SetBridgeBank is a paid mutator transaction binding the ethContract method 0x814c92c3.
//
...
func (_CosmosBridge *CosmosBridgeTransactor) SetBridgeBank(opts *bind.TransactOpts, _bridgeBank common.Address) (*types.Transaction, error) {
	return _CosmosBridge.ethContract.Transact(opts, "setBridgeBank", _bridgeBank)
}
...
// SetOracle is a paid mutator transaction binding the ethContract method 0x7adbf973.
//
...
func (_CosmosBridge *CosmosBridgeTransactor) SetOracle(opts *bind.TransactOpts, _oracle common.Address) (*types.Transaction, error) {
	return _CosmosBridge.ethContract.Transact(opts, "setOracle", _oracle)
}
...
// CosmosBridgeLogBridgeBankSetIterator is returned from FilterLogBridgeBankSet and is used to iterate over the raw logs and unpacked data for LogBridgeBankSet events raised by the EvrnetBridge ethContract.
type CosmosBridgeLogBridgeBankSetIterator struct {
	Event *CosmosBridgeLogBridgeBankSet // Event containing the ethContract specifics and raw log
...
// CosmosBridgeLogBridgeBankSet represents a LogBridgeBankSet event raised by the EvrnetBridge ethContract.
type CosmosBridgeLogBridgeBankSet struct {
	BridgeBank common.Address
	Raw        types.Log // Blockchain specific contextual infos
}

// FilterLogBridgeBankSet is a free log retrieval operation binding the ethContract event 0xc8b65043fb196ac032b79a435397d1d14a96b4e9d12e366c3b1f550cb01d2dfa.
//
...
func (_CosmosBridge *CosmosBridgeFilterer) FilterLogBridgeBankSet(opts *bind.FilterOpts) (*CosmosBridgeLogBridgeBankSetIterator, error) {
	...
	logs, sub, err := _CosmosBridge.ethContract.FilterLogs(opts, "LogBridgeBankSet")
	if err != nil {
		return nil, err
	}
	return &CosmosBridgeLogBridgeBankSetIterator{ethContract: _CosmosBridge.ethContract, event: "LogBridgeBankSet", logs: logs, sub: sub}, nil
}

// WatchLogBridgeBankSet is a free log subscription operation binding the ethContract event 0xc8b65043fb196ac032b79a435397d1d14a96b4e9d12e366c3b1f550cb01d2dfa.
//
// Solidity: event LogBridgeBankSet(address _bridgeBank)
func (_CosmosBridge *CosmosBridgeFilterer) WatchLogBridgeBankSet(opts *bind.WatchOpts, sink chan<- *CosmosBridgeLogBridgeBankSet) (event.Subscription, error) {
	...
	logs, sub, err := _CosmosBridge.ethContract.WatchLogs(opts, "LogBridgeBankSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _CosmosBridge.ethContract.UnpackLog(event, "LogBridgeBankSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// CosmosBridgeLogNewProphecyClaimIterator is returned from FilterLogNewProphecyClaim and is used to iterate over the raw logs and unpacked data for LogNewProphecyClaim events raised by the EvrnetBridge ethContract.
type CosmosBridgeLogNewProphecyClaimIterator struct {
	Event *CosmosBridgeLogNewProphecyClaim // Event containing the ethContract specifics and raw log
...
// CosmosBridgeLogNewProphecyClaim represents a LogNewProphecyClaim event raised by the EvrnetBridge ethContract.
...
// FilterLogNewProphecyClaim is a free log retrieval operation binding the ethContract event 0x4c4b04a2b190e6bb01b6243f150fc76174861acd19cf98841801baaff5262dd8.
//
...
func (_CosmosBridge *CosmosBridgeFilterer) FilterLogNewProphecyClaim(opts *bind.FilterOpts) (*CosmosBridgeLogNewProphecyClaimIterator, error) {
	...
	logs, sub, err := _CosmosBridge.ethContract.FilterLogs(opts, "LogNewProphecyClaim")
	if err != nil {
		return nil, err
	}
	return &CosmosBridgeLogNewProphecyClaimIterator{ethContract: _CosmosBridge.ethContract, event: "LogNewProphecyClaim", logs: logs, sub: sub}, nil
}

// WatchLogNewProphecyClaim is a free log subscription operation binding the ethContract event 0x4c4b04a2b190e6bb01b6243f150fc76174861acd19cf98841801baaff5262dd8.
//
// Solidity: event LogNewProphecyClaim(uint256 _prophecyID, uint8 _claimType, bytes _cosmosSender, address _ethereumReceiver, address _validatorAddress, address _tokenAddress, string _symbol, uint256 _amount)
func (_CosmosBridge *CosmosBridgeFilterer) WatchLogNewProphecyClaim(opts *bind.WatchOpts, sink chan<- *CosmosBridgeLogNewProphecyClaim) (event.Subscription, error) {
	...
	logs, sub, err := _CosmosBridge.ethContract.WatchLogs(opts, "LogNewProphecyClaim")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _CosmosBridge.ethContract.UnpackLog(event, "LogNewProphecyClaim", log); err != nil {
					return err
				}
				event.Raw = log
...
// CosmosBridgeLogOracleSetIterator is returned from FilterLogOracleSet and is used to iterate over the raw logs and unpacked data for LogOracleSet events raised by the EvrnetBridge ethContract.
type CosmosBridgeLogOracleSetIterator struct {
	Event *CosmosBridgeLogOracleSet // Event containing the ethContract specifics and raw log
...
// CosmosBridgeLogOracleSet represents a LogOracleSet event raised by the EvrnetBridge ethContract.
type CosmosBridgeLogOracleSet struct {
	Oracle common.Address
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterLogOracleSet is a free log retrieval operation binding the ethContract event 0x6efb0434342713e2e9b1501dbebf76b4ed18406ea77ab5d56535cc26dec3adc0.
//
...
func (_CosmosBridge *CosmosBridgeFilterer) FilterLogOracleSet(opts *bind.FilterOpts) (*CosmosBridgeLogOracleSetIterator, error) {
	...
	logs, sub, err := _CosmosBridge.ethContract.FilterLogs(opts, "LogOracleSet")
	if err != nil {
		return nil, err
	}
	return &CosmosBridgeLogOracleSetIterator{ethContract: _CosmosBridge.ethContract, event: "LogOracleSet", logs: logs, sub: sub}, nil
}

// WatchLogOracleSet is a free log subscription operation binding the ethContract event 0x6efb0434342713e2e9b1501dbebf76b4ed18406ea77ab5d56535cc26dec3adc0.
//
// Solidity: event LogOracleSet(address _oracle)
func (_CosmosBridge *CosmosBridgeFilterer) WatchLogOracleSet(opts *bind.WatchOpts, sink chan<- *CosmosBridgeLogOracleSet) (event.Subscription, error) {
	...
	logs, sub, err := _CosmosBridge.ethContract.WatchLogs(opts, "LogOracleSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _CosmosBridge.ethContract.UnpackLog(event, "LogOracleSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// CosmosBridgeLogProphecyCompletedIterator is returned from FilterLogProphecyCompleted and is used to iterate over the raw logs and unpacked data for LogProphecyCompleted events raised by the EvrnetBridge ethContract.
type CosmosBridgeLogProphecyCompletedIterator struct {
	Event *CosmosBridgeLogProphecyCompleted // Event containing the ethContract specifics and raw log
...
// CosmosBridgeLogProphecyCompleted represents a LogProphecyCompleted event raised by the EvrnetBridge ethContract.
...
// FilterLogProphecyCompleted is a free log retrieval operation binding the ethContract event 0x79e7c1c0bd54f11809c3bf6023c242783602d61ceff272c6bba6f8559c24ad0d.
//
...
func (_CosmosBridge *CosmosBridgeFilterer) FilterLogProphecyCompleted(opts *bind.FilterOpts) (*CosmosBridgeLogProphecyCompletedIterator, error) {
	...
	logs, sub, err := _CosmosBridge.ethContract.FilterLogs(opts, "LogProphecyCompleted")
	if err != nil {
		return nil, err
	}
	return &CosmosBridgeLogProphecyCompletedIterator{ethContract: _CosmosBridge.ethContract, event: "LogProphecyCompleted", logs: logs, sub: sub}, nil
}

// WatchLogProphecyCompleted is a free log subscription operation binding the ethContract event 0x79e7c1c0bd54f11809c3bf6023c242783602d61ceff272c6bba6f8559c24ad0d.
//
// Solidity: event LogProphecyCompleted(uint256 _prophecyID, uint8 _claimType)
func (_CosmosBridge *CosmosBridgeFilterer) WatchLogProphecyCompleted(opts *bind.WatchOpts, sink chan<- *CosmosBridgeLogProphecyCompleted) (event.Subscription, error) {
	...
	logs, sub, err := _CosmosBridge.ethContract.WatchLogs(opts, "LogProphecyCompleted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _CosmosBridge.ethContract.UnpackLog(event, "LogProphecyCompleted", log); err != nil {
					return err
				}
				event.Raw = log
