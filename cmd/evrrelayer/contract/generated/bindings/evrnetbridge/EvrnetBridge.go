...
// DeployCosmosBridge deploys a new Ethereum contract, binding an instance of EvrnetBridge to it.
func DeployCosmosBridge(auth *bind.TransactOpts, backend bind.ContractBackend, _operator common.Address, _valset common.Address) (common.Address, *types.Transaction, *EvrnetBridge, error) {
	...
	return address, tx, &EvrnetBridge{CosmosBridgeCaller: CosmosBridgeCaller{contract: contract}, CosmosBridgeTransactor: CosmosBridgeTransactor{contract: contract}, CosmosBridgeFilterer: CosmosBridgeFilterer{contract: contract}}, nil
}
...
// NewCosmosBridge creates a new instance of EvrnetBridge, bound to a specific deployed contract.
func NewCosmosBridge(address common.Address, backend bind.ContractBackend) (*EvrnetBridge, error) {
	...
	return &EvrnetBridge{CosmosBridgeCaller: CosmosBridgeCaller{contract: contract}, CosmosBridgeTransactor: CosmosBridgeTransactor{contract: contract}, CosmosBridgeFilterer: CosmosBridgeFilterer{contract: contract}}, nil
}

// NewCosmosBridgeCaller creates a new read-only instance of EvrnetBridge, bound to a specific deployed contract.
...
// NewCosmosBridgeTransactor creates a new write-only instance of EvrnetBridge, bound to a specific deployed contract.
...
// NewCosmosBridgeFilterer creates a new log filterer instance of EvrnetBridge, bound to a specific deployed contract.
...
// CosmosBridgeLogBridgeBankSetIterator is returned from FilterLogBridgeBankSet and is used to iterate over the raw logs and unpacked data for LogBridgeBankSet events raised by the EvrnetBridge contract.
...
// CosmosBridgeLogBridgeBankSet represents a LogBridgeBankSet event raised by the EvrnetBridge contract.
...
// CosmosBridgeLogNewProphecyClaimIterator is returned from FilterLogNewProphecyClaim and is used to iterate over the raw logs and unpacked data for LogNewProphecyClaim events raised by the EvrnetBridge contract.
...
// CosmosBridgeLogNewProphecyClaim represents a LogNewProphecyClaim event raised by the EvrnetBridge contract.
...
// CosmosBridgeLogOracleSetIterator is returned from FilterLogOracleSet and is used to iterate over the raw logs and unpacked data for LogOracleSet events raised by the EvrnetBridge contract.
...
// CosmosBridgeLogOracleSet represents a LogOracleSet event raised by the EvrnetBridge contract.
...
// CosmosBridgeLogProphecyCompletedIterator is returned from FilterLogProphecyCompleted and is used to iterate over the raw logs and unpacked data for LogProphecyCompleted events raised by the EvrnetBridge contract.
...
// CosmosBridgeLogProphecyCompleted represents a LogProphecyCompleted event raised by the EvrnetBridge contract.
